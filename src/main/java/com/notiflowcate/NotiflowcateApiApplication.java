...
@EnableAsync
@ComponentScan(basePackages = {"com.notiflowcate.*"})
@EnableCaching
@EnableSwagger2
public class NotiflowcateApiApplication {

    @Autowired
    public NotiflowcateApiApplication(TypeResolver typeResolver) {
    ...
    public static void main(String[] args) {
        ...
        // Start the reactor!
        SpringApplication.run(NotiflowcateApiApplication.class, args);
    }
    ...
    public Docket communityAlertApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(
                        new ApiInfo(
                                "Notiflowcate µservice API",
                                "Notiflowcate Event Engine designed to track user interactions through Geofences, Beacons and provide contextual notifications via .",
                                "1.0",
                                "http://dayelostra.co",
                                new Contact("Dayel Ostraco", "http://www.dayelostra.co", "dayel.ostraco@gmail.com"),
                                "The MIT License",
    ...
    private ApiKey apiKey() {
        return new ApiKey("notiflowcate", "apiKey", "header");
    }
